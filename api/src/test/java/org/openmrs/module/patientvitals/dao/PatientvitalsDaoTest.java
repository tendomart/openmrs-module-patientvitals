 ...
 */
public class PatientvitalsDaoTest extends BaseModuleContextSensitiveTest {
	...
	@Test
	@Ignore("Unignore if you want to make the PatientVitals class persistable, see also PatientVitals and liquibase.xml")
	public void saveItem_shouldSaveAllPropertiesInDb() {
		//Given
		PatientVitals item = new PatientVitals();
		...
		//Then
		PatientVitals savedItem = dao.getItemByUuid(item.getUuid());
